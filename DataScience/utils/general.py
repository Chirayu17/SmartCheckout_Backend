...
from DataScience.utils.google_utils import gsutil_getsize
from DataScience.utils.metrics import fitness
from DataScience.utils.torch_utils import init_torch_seeds
...
def strip_optimizer(f='best.pt', s=''):  # from DataScience..general import *; strip_optimizer()
